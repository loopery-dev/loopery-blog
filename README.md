...
| 글 | 묶은 원본 노트 |
|---|---|
| [테슬라 기업 프로필](https://loopery.dev/blog/tesla/) | `entities/Tesla.md` |
| [Tesla Ecosystem and Physical AI](https://loopery.dev/blog/tesla-ecosystem-and-physical-ai/) | `synthesis/Tesla-Ecosystem-and-Physical-AI.md` |
| [왜 자율주행 AI는 '추론'을 시작했나](https://loopery.dev/blog/reasoning-centric-autonomous-driving/) | `synthesis/Reasoning-Centric-Autonomous-Driving.md`, `concepts/VLA-for-Autonomous-Driving.md`, `entities/NVIDIA.md` |
| [Alpamayo-R1 해부](https://loopery.dev/blog/alpamayo-r1-deep-dive/) | `entities/Alpamayo-R1.md`, `entities/Cosmos-Reason.md`, `entities/AlpaSim.md`, `concepts/Chain-of-Causation.md`, `concepts/Flow-Matching-Trajectory-Decoder.md`, `concepts/Reasoning-Action-Consistency-RL.md` |
| [FSD 두뇌를 물려받은 로봇들](https://loopery.dev/blog/fsd-cybercab-optimus-unboxed/) | `concepts/Full-Self-Driving.md`, `entities/Cybercab.md`, `entities/Tesla-Optimus.md`, `concepts/Unboxed-Manufacturing.md` |
| [메가팩, AI 시대 전력망의 숨은 수혜자](https://loopery.dev/blog/megapack-ai-power-grid/) | `entities/Megapack.md` |
